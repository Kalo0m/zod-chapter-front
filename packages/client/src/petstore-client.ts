...
const Category: z.ZodType<Category> = z.object({ id: z.number().int(), name: z.string() }).partial().passthrough()
const Tag: z.ZodType<Tag> = z.object({ id: z.number().int(), name: z.string() }).partial().passthrough()
const Pet: z.ZodType<Pet> = z
  .object({
